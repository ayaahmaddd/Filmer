...
<section class="movies" id="movies">
    ...
    $query = "SELECT movie.id , movie.imageurl , movie.year , movie.name , category.name FROM movie JOIN best ON movie.id = best.movie_id JOIN category ON category.id = movie.cat_id WHERE best.users_id=".$id;
